...
currentFleet_scatter.savefig("currentFleet_scatter.png",bbox_inches='tight')
plt.clf()
newFleet_scatter=sns.lmplot(newFleet.columns[0],newFleet.columns[1],data=newFleet,fit_reg=False)
newFleet_scatter.savefig('newFleet_scatter.png',bbox_inches='tight')
...
currentFleet_histogram.savefig('currentFleet_histogram.png',bbox_inches='tight')
newFleet_histogram=sns.distplot(newFleet.T[1],bins=7,kde=False,rug=True).get_figure()
axes.set_xlabel("New Fleet")
axes.set_ylabel('probability')
newFleet_histogram.savefig('new_fleet_histogram.png',bbox_inches='tight')
...
current_boot.savefig("currentFleet_bootstrap.png",bbox_inches='tight')

newFleet_boot=sns.lmplot(newFleet_bootstrap.columns[0],newFleet_bootstrap.columns[1],data=newFleet_bootstrap,hue='value')
newFleet_boot.savefig("newFleet_bootstrap.png",bbox_inches='tight')
